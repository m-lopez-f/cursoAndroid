...
3.- Crea un array de 6 alumnos inicializados todos a los valores por defecto del alumno.
    Modifica el nombre y apellidos del primer alumno. Muestra por consola al primer y al último
    alumno.
*/
...
public class MyClass {
    public static void main(String args[]) {
        ...
        alumnos[0].setNombre("Pepi");
        alumnos[0].setApellidos("Prueba");
